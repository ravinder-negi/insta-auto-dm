        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1.1fr)_280px] lg:items-start">
          <div className="animate-fade-in-up max-w-md">
            ...
            <h1 className="mt-5 text-4xl leading-[1.05] font-bold tracking-tight sm:text-5xl">
              ...
              <br />
              into{" "}
              <span className="bg-[linear-gradient(100deg,#818cf8,#c084fc_60%,#f0abfc)] bg-clip-text text-transparent">
                customers.
              </span>
            </h1>
          ...
          >
            ...
            >
              ...
              <circle cx="100" cy="210" r="3.5" fill="#a5b4fc" className="animate-pulse-soft" />
              <circle
                cx="145"
                cy="290"
                r="3.5"
            ...
            <div className="absolute top-28 left-22 flex max-w-37.5 items-start gap-2 rounded-2xl rounded-tl-sm bg-white px-3.5 py-2.5 text-zinc-800 shadow-xl">
              <ChatIcon className="mt-0.5 h-4 w-4 shrink-0 text-violet-500" />
            ...
            <SendIcon className="absolute right-6 bottom-8 h-9 w-9 rotate-45 text-violet-300" />
          </div>
        </div>
